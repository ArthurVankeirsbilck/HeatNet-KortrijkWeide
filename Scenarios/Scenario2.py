...
model.P_gen = Param(model.N,model.Plants, initialize={
    (1, 'Plant1'): 478, (1, 'Plant2'): 0,(1, 'Plant3'): 0,
...
def demandcons(model, i, t):
    if i == 3:
        ...
        return  model.I[i,t]*model.Z1[i,t] - model.E[i,t]*model.Z2[i,t] + sum(model.p[p,i,t] for p in model.Plants) == model.demand[i,t]+(236.69/1000)*model.lengths[i]
